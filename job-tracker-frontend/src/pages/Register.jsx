    ...
    <div className="animate-fade" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '70vh' }}>
      <div className="card" style={{ width: '100%', maxWidth: '500px', padding: '3rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Join JobTracker</h1>
          <p style={{ color: 'var(--text-muted)' }}>Start your journey as a candidate or employer</p>
        </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div 
                ...
                style={{ 
                  ...
                  cursor: 'pointer', 
                  textAlign: 'center',
                  background: formData.role === 'candidate' ? 'var(--primary-glow)' : 'transparent',
                  transition: 'all 0.2s'
                }}
              >
                <div style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>👋</div>
                <div style={{ fontWeight: '700', color: formData.role === 'candidate' ? 'var(--primary)' : 'var(--text-main)' }}>Candidate</div>
              </div>
              <div 
                ...
                style={{ 
                  ...
                  cursor: 'pointer', 
                  textAlign: 'center',
                  background: formData.role === 'employer' ? 'var(--primary-glow)' : 'transparent',
                  transition: 'all 0.2s'
                }}
              >
                <div style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>🏢</div>
                <div style={{ fontWeight: '700', color: formData.role === 'employer' ? 'var(--primary)' : 'var(--text-main)' }}>Employer</div>
              </div>
            </div>
          </div>
